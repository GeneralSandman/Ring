...
function main() {
    ...
    fmt::println_int(len(global_double_array_0));
    fmt::println_int(capacity(global_double_array_0));
    debug::debug_assert(len(global_double_array_0) == 201);
    debug::debug_assert(capacity(global_double_array_0) == 400);


    fmt::println_string("\ntest cast 3 ------------------------");
    debug::debug_assert(global_double_array_0[0]   == 0.00);
    debug::debug_assert(global_double_array_0[199] == 0.00);
    debug::debug_assert(global_double_array_0[200] == 3.456789);
}