...
function main() {
    ...
    debug::debug_assert(len(global_int64_array_0[0,0,0,0]) == 5);
    debug::debug_assert(len(global_int64_array_0[0,0,0,0,0]) == 6);
    debug::debug_assert(len(global_int64_array_0[0,0,0,0,0,0]) == 7);
    debug::debug_assert(len(global_int64_array_0[0,0,0,0,0,0,0]) == 8);
