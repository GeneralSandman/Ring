...
function main() {
    ...
    debug::debug_assert(len(global_int64_array_0[0,0]) == 10);
    debug::debug_assert(len(global_int64_array_0[1,9]) == 10);
    debug::debug_assert(len(global_int64_array_0[2,9]) == 10);
