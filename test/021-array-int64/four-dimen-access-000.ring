...
fn main() {
    ...
    debug::assert(capacity(global_int64_array_0) == 1);
    debug::assert(capacity(global_int64_array_0[0]) == 2);
    debug::assert(capacity(global_int64_array_0[0,0]) == 3);
    debug::assert(capacity(global_int64_array_0[0,0,0]) == 8);
}
