...
function main() {
    ...
    global_string_array_0 = new string[a,b,c,d,e,f,g,h];

    fmt::println_int(len(global_string_array_0));
    fmt::println_int(len(global_string_array_0[0]));
    fmt::println_int(len(global_string_array_0[0,0]));
	fmt::println_int(len(global_string_array_0[0,0,0]));
	fmt::println_int(len(global_string_array_0[0,0,0,0]));
	fmt::println_int(len(global_string_array_0[0,0,0,0,0]));
	fmt::println_int(len(global_string_array_0[0,0,0,0,0,0]));
