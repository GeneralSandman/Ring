...
fn main() {
    ...
    debug::assert(len(global_bool_array_0) == a);
    debug::assert(len(global_bool_array_0[0]) == b);
    debug::assert(len(global_bool_array_0[0,0]) == c);
    debug::assert(len(global_bool_array_0[0,0,0]) == d);
    debug::assert(len(global_bool_array_0[0,0,0,0]) == e);
    debug::assert(len(global_bool_array_0[0,0,0,0,0]) == f);
    debug::assert(len(global_bool_array_0[0,0,0,0,0,0]) == g);
    debug::assert(len(global_bool_array_0[0,0,0,0,0,0,0]) == h);
