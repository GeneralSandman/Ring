...
function main() {
    ...
    debug::debug_assert(len(global_bool_array_0) == a);
    debug::debug_assert(len(global_bool_array_0[0]) == b);
    debug::debug_assert(len(global_bool_array_0[0,0]) == c);
    debug::debug_assert(len(global_bool_array_0[0,0,0]) == d);
    debug::debug_assert(len(global_bool_array_0[0,0,0,0]) == e);
    debug::debug_assert(len(global_bool_array_0[0,0,0,0,0]) == f);
    debug::debug_assert(len(global_bool_array_0[0,0,0,0,0,0]) == g);
    debug::debug_assert(len(global_bool_array_0[0,0,0,0,0,0,0]) == h);
