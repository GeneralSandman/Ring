...
function return_int_array_1_0() -> (int[]) {
	return int[]{0};
}
function return_int_array_1_1() -> (int[]) {
	return int[]{1};
}
function return_int_array_1_2() -> (int[]) {
	return int[]{1, 0, 1, 0};
}
function return_int_array_1_3() -> (int[]) {
	return int[]{1, 0, 1, 0, 1};
}


function return_int_array_2_0() -> (int[], int[]) {
	return int[]{0}, int[]{1};
}
function return_int_array_2_1() -> (int[], int[]) {
	return int[]{1}, int[]{0};
}
function return_int_array_2_2() -> (int[], int[]) {
	return int[]{1, 0, 1, 0}, int[]{1, 0, 1, 0};
}
function return_int_array_2_3() -> (int[], int[]) {
	return int[]{1, 0, 1, 0, 1}, int[]{1, 0, 1, 0, 1};
}



function return_int_array_8_0() -> (int[], int[], int[], int[], int[], int[], int[], int[]) {
