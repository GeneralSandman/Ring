...
function return_1_double_array_1() -> (double[]) {
	return double[]{1.0};
}

function return_1_double_array_2() -> (double[,]) {
	return double[,]{
		double[]{1.0, 0.0},
		double[]{0.0, 1.0},
	};
...
function return_1_double_array_3() -> (double[,,]) {
	return double[,,]{
		double[,]{
			double[]{1.0, 0.0, 1.0},
			double[]{0.0, 1.0, 0.0},
...
function return_1_double_array_4() -> (double[,,,]) {
	return double[,,,]{
		double[,,]{
			double[,]{
				double[]{1.0, 0.0, 1.0},
