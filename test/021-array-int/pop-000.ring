...
function main() {
    ...
    debug::debug_assert(global_int_array_0[199] == 0);
    ...
    debug::debug_assert(global_int_value_0 == 123);
    debug::debug_assert(len(global_int_array_0) == 199);
    debug::debug_assert(capacity(global_int_array_0) == 200);
    ...
    debug::debug_assert(global_int_value_0 == 666);
    debug::debug_assert(len(global_int_array_0) == 198);
    debug::debug_assert(capacity(global_int_array_0) == 200);
}