...
function main() {
    ...
    debug::debug_assert(capacity(global_int_array_0) == 1);
    debug::debug_assert(capacity(global_int_array_0[0]) == 2);
    debug::debug_assert(capacity(global_int_array_0[0,0]) == 3);
    debug::debug_assert(capacity(global_int_array_0[0,0,0]) == 8);
}
