...
fn main() {
    ...
    fmt::println_int(cap(global_int_array_0[0]));
    fmt::println_int(cap(global_int_array_0[0,0]));
    fmt::println_int(cap(global_int_array_0[0,0,0]));

    debug::assert(cap(global_int_array_0) == 1);
    debug::assert(cap(global_int_array_0[0]) == 2);
    debug::assert(cap(global_int_array_0[0,0]) == 3);
    debug::assert(cap(global_int_array_0[0,0,0]) == 8);
}
