...
function main() {
    ...
    fmt::println_int(len(global_int_array_0));
    fmt::println_int(capacity(global_int_array_0));
    debug::debug_assert(len(global_int_array_0) == 5);
    ...
    fmt::println_string("\ntest cast 6 value------------------------");
    debug::debug_assert(global_int_array_0[0]  == 123);
    debug::debug_assert(global_int_array_0[1]  == 123);
    debug::debug_assert(global_int_array_0[2]  == 123);
    debug::debug_assert(global_int_array_0[3]  == 123);
    debug::debug_assert(global_int_array_0[4]  == 123);


    fmt::println_string("\ntest cast 7 value------------------------");
    for(int_value in range global_int_array_0) {
        debug::debug_assert(int_value  == 123);
    }
}