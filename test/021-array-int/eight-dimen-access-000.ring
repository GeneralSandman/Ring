...
fn main() {
    ...
    debug::assert(len(global_int_array_0[0,0,0,0]) == 5);
    debug::assert(len(global_int_array_0[0,0,0,0,0]) == 6);
    debug::assert(len(global_int_array_0[0,0,0,0,0,0]) == 7);
    debug::assert(len(global_int_array_0[0,0,0,0,0,0,0]) == 8);
