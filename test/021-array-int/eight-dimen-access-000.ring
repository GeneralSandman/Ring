...
@main
function main() {
    global_int_array_0 = new int[1,2,3,4,5,6,7,8];

    fmt::println_string("test cast 1 ------------------------");
    debug::debug_assert(len(global_int_array_0) == 1);
    debug::debug_assert(len(global_int_array_0[0]) == 2);
    debug::debug_assert(len(global_int_array_0[0,0]) == 3);
    debug::debug_assert(len(global_int_array_0[0,0,0]) == 4);
    debug::debug_assert(len(global_int_array_0[0,0,0,0]) == 5);
    debug::debug_assert(len(global_int_array_0[0,0,0,0,0]) == 6);
    debug::debug_assert(len(global_int_array_0[0,0,0,0,0,0]) == 7);
    debug::debug_assert(len(global_int_array_0[0,0,0,0,0,0,0]) == 8);
