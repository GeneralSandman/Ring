...
function main() {
    ...
    debug::debug_assert(len(global_int_array_0)    == 10);
    ...
    debug::debug_assert(len(global_int_array_0[3]) == 10);
    debug::debug_assert(len(global_int_array_0[4]) == 10);
    debug::debug_assert(len(global_int_array_0[5]) == 10);
    debug::debug_assert(len(global_int_array_0[6]) == 10);
    debug::debug_assert(len(global_int_array_0[7]) == 10);
    debug::debug_assert(len(global_int_array_0[8]) == 10);
    debug::debug_assert(len(global_int_array_0[9]) == 10);
