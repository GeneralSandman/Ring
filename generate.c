...
// 添加全局变量
void add_global_variable(Ring_Compiler *ring_compiler, Ring_VirtualMachine_Executer *ring_executer) {
}

// 添加函数定义
void add_functions(Ring_Compiler *ring_compiler, Ring_VirtualMachine_Executer *ring_executer) {
}

// 添加顶层代码
void add_top_level_code(Ring_Compiler *ring_compiler, Ring_VirtualMachine_Executer *ring_executer) {
}
