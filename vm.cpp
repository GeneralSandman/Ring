...
RVM_Opcode_Info RVM_Opcode_Infos[] = {
    ...
    // class
    {RVM_CODE_POP_FIELD_BOOL, "pop_field_bool", OPCODE_OPERAND_TYPE_2BYTE, -1, 3, "assign to class field whith bool", "[bool,object]->[]"},
    {RVM_CODE_POP_FIELD_INT, "pop_field_int", OPCODE_OPERAND_TYPE_2BYTE, -1, 3, "", "[int,object]->[]"},
    {RVM_CODE_POP_FIELD_DOUBLE, "pop_field_double", OPCODE_OPERAND_TYPE_2BYTE, -1, 3, "", "[double,object]->[]"},
    {RVM_CODE_PUSH_FIELD_BOOL, "push_field_bool", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", "[object]->[bool]"},
    {RVM_CODE_PUSH_FIELD_INT, "push_field_int", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", "[object]->[int]"},
    {RVM_CODE_PUSH_FIELD_DOUBLE, "push_field_double", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", "[object]->[double]"},
    ...
    // new heap memory
    {RVM_CODE_NEW_ARRAY_BOOL, "new_array_bool", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    ...
    {RVM_CODE_NEW_ARRAY_STRING, "new_array_string", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_NEW_ARRAY_OBJECT, "new_array_object", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_NEW_ARRAY_LITERAL_BOOL, "new_array_literal_bool", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    ...
    // range
    {RVM_CODE_FOR_RANGE_ARRAY_BOOL, "range_array_bool", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_FOR_RANGE_ARRAY_INT, "range_array_int", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_FOR_RANGE_ARRAY_DOUBLE, "range_array_double", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_FOR_RANGE_ARRAY_STRING, "range_array_string", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_FOR_RANGE_ARRAY_OBJECT, "range_array_object", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
    {RVM_CODE_FOR_RANGE_STRING, "range_string", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "", ""},
