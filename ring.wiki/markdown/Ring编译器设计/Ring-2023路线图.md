...
./test/011-global-variable/global-variable-double-000.ring   1
./test/011-global-variable/global-variable-string-000.ring   1
./test/012-local-variable/local-variable-double-000.ring     1
./test/012-local-variable/local-variable-string-000.ring     1

```

- ./test/012-local-variable/local-variable-double-000.ring 
- ./test/011-global-variable/global-variable-double-000.ring


```
	local_double_value_1 = -65536.0;
	fmt::println_double(local_double_value_1);
   println_double 显示的变量不对
```

- ./test/012-local-variable/local-variable-string-000.ring
- ./test/011-global-variable/global-variable-string-000.ring
