...
## A. Feature: class中的field类型可以为匿名函数类型 ✅
...
## X. Feature: 匿名函数变量在没有初始化的时候，如何保证 调用他们的合法性 ✅
...
## X. Feature: 初始化匿名数组的时候，要做强制的类型检查，包括基础类型 ✅
...
## X. Feature: 匿名函数自由变量 支持 class-object ✅
...
## X. Feature: class中field初始化的时候，强制检查类型  ✅
...
## 8. Feature: 支持 类似于 php 的 var_dump 函数  ✅
...
## 10. Feature: std package runtime
...
## 11. Feature: native 函数支持多返回值 ✅

## 12. Feature: 语法 `in range` 调整为 `= range`  ✅



## 13. Optimize: break continue 语义上应该继续完善 ✅
...
## 14. Feature: 数组为空/访问越界 虚拟机应该panic报错，同时抛出堆栈，方便排错 ✅
...
## 15. Feature: for-range 赋值进行详细的语法/语义检查  ✅
...
## 17. Update: main 函数的参数 `var string[] args` 默认会占用空间，导致gc在测试的过程中不好调试 ✅
...
## 18. 关于 rvm 中 constant_pool 字符串常量的优化 ✅
...
## 19. Feature: for-range 中，array 参数 进行丰富  ✅
