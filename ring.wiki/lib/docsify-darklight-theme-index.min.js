window.$docsify.plugins = [].concat((e, o) => {
    ...
    if (o.config.hasOwnProperty("darklightTheme")) {
        ...
        for (var [r, l] of Object.entries(t))
            "light" !== r && "dark" !== r && (t[r] = l,
                document.documentElement.style.setProperty("--" + r, l));
    ...
    var d = e => {
        if (localStorage.setItem("DARK_LIGHT_THEME", e),
            t.defaultTheme = e,
            "light" == e)
    ...
    e.afterEach((function (e, o) {
        ...
        e.doneEach((function () {
            ...
            "light" == e || "dark" == e ? (t.defaultTheme = e,
                d(t.defaultTheme)) : d(t.defaultTheme);
