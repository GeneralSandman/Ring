...
RVM_Opcode_Info RVM_Opcode_Infos[] = {
    ...
    {RVM_CODE_NEW_ARRAY_OBJECT, "new_array_object", OPCODE_OPERAND_TYPE_3BYTE, 1, 4, "", ""},
    ...
    // range
    {RVM_CODE_FOR_RANGE_ARRAY_BOOL, "range_array_bool", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "range bool value for array", ""},
    {RVM_CODE_FOR_RANGE_ARRAY_INT, "range_array_int", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "range int value for array", ""},
    {RVM_CODE_FOR_RANGE_ARRAY_DOUBLE, "range_array_double", OPCODE_OPERAND_TYPE_2BYTE, 1, 3, "range double value for array", ""},
