...
RVM_Opcode_Info RVM_Opcode_Infos[] = {
    ...
    // static
    {RVM_CODE_POP_STATIC_BOOL, "pop_static_bool", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "bool assign to global-variable", ""},
    {RVM_CODE_POP_STATIC_INT, "pop_static_int", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "int assign to global-variable", ""},
    {RVM_CODE_POP_STATIC_DOUBLE, "pop_static_double", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "double assign to global-variable", ""},
    {RVM_CODE_POP_STATIC_STRING, "pop_static_string", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "string assign to global-variable", ""},
    {RVM_CODE_POP_STATIC_CLASS_OB, "pop_static_class_ob", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "class-object assign to global-variable", ""},
    {RVM_CODE_POP_STATIC_ARRAY, "pop_static_array", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "array assign to global-variable", ""},
    {RVM_CODE_PUSH_STATIC_BOOL, "push_static_bool", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push global-variable's bool to stack", ""},
    {RVM_CODE_PUSH_STATIC_INT, "push_static_int", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push global-variable's int to stack", ""},
    {RVM_CODE_PUSH_STATIC_DOUBLE, "push_static_double", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push global-variable's double to stack", ""},
    {RVM_CODE_PUSH_STATIC_STRING, "push_static_string", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push global-variable's string to stack", ""},
    {RVM_CODE_PUSH_STATIC_CLASS_OB, "push_static_class_ob", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push global-variable's class-object to stack", ""},
    {RVM_CODE_PUSH_STATIC_ARRAY, "push_static_array", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push global-variable's array to stack", ""},


    // stack
    {RVM_CODE_POP_STACK_BOOL, "pop_stack_bool", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "bool assign to local-variable", ""},
    {RVM_CODE_POP_STACK_INT, "pop_stack_int", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "int assign to local-variable", ""},
    {RVM_CODE_POP_STACK_DOUBLE, "pop_stack_double", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "double assign to local-variable", ""},
    {RVM_CODE_POP_STACK_STRING, "pop_stack_string", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "string assign to local-variable", ""},
    {RVM_CODE_POP_STACK_CLASS_OB, "pop_stack_class_ob", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "class-object assign to local-variable", ""},
    {RVM_CODE_POP_STACK_ARRAY, "pop_stack_array", OPCODE_OPERAND_TYPE_2BYTE_As, -1, 3, "array assign to local-variable", ""},
    {RVM_CODE_PUSH_STACK_BOOL, "push_stack_bool", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push local-variable's bool to stack", ""},
    {RVM_CODE_PUSH_STACK_INT, "push_stack_int", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push local-variable's int to stack", ""},
    {RVM_CODE_PUSH_STACK_DOUBLE, "push_stack_double", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push local-variable's double to stack", ""},
    {RVM_CODE_PUSH_STACK_STRING, "push_stack_string", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push local-variable's string to stack", ""},
    {RVM_CODE_PUSH_STACK_CLASS_OB, "push_stack_class_ob", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push local-variable's class-object to stack", ""},
    {RVM_CODE_PUSH_STACK_ARRAY, "push_stack_array", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "push local-variable's array to stack", ""},
    ...
    {RVM_CODE_PUSH_ARRAY_CLASS_OBJECT, "push_array_class_object", OPCODE_OPERAND_TYPE_0BYTE, -1, 1, "", ""},
    ...
    {RVM_CODE_POP_ARRAY_CLASS_OBJECT, "pop_array_class_object", OPCODE_OPERAND_TYPE_0BYTE, -3, 1, "assign to object array by index", "[int,object,int]->[]"},
    ...
    {RVM_CODE_ARRAY_APPEND_CLASS_OBJECT, "array_append_class_object", OPCODE_OPERAND_TYPE_0BYTE, -2, 1, "assign to object array by index", "[object,object]->[]"},
    // array pop
    ...
    {RVM_CODE_ARRAY_POP_CLASS_OBJECT, "array_pop_class_object", OPCODE_OPERAND_TYPE_0BYTE, 0, 1, "assign to object array by index", "[object]->[object]"},
    ...
    {RVM_CODE_NEW_ARRAY_CLASS_OBJECT, "new_array_class_object", OPCODE_OPERAND_TYPE_3BYTE_ABs, 1, 4, "", ""},
    ...
    {RVM_CODE_NEW_ARRAY_LITERAL_CLASS_OBJECT, "new_array_literal_class_object", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "", ""},
    ...
    {RVM_CODE_FOR_RANGE_ARRAY_CLASS_OBJECT, "range_array_class_object", OPCODE_OPERAND_TYPE_2BYTE_As, 1, 3, "range object value for array", ""},
