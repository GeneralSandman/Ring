...
RVM_Opcode_Info RVM_Opcode_Infos[] = {
    ...
    {RVM_CODE_PUSH_INT64, "push_int64", OPCODE_OPERAND_TYPE_2BYTE_As, 1, "push constant int value to stack", "[]-->[int]"},               // 后边紧跟 int 常量 2 的索引 这里的还要 改一下 OPCODE_OPERAND_TYPE_2BYTE
    ...
    {RVM_CODE_POP_STATIC_INT64, "pop_static_int64", OPCODE_OPERAND_TYPE_2BYTE_As, -1, "int64 assign to global-variable", ""},
    ...
    {RVM_CODE_PUSH_STATIC_INT64, "push_static_int64", OPCODE_OPERAND_TYPE_2BYTE_As, 1, "push global-variable's int64 to stack", ""},
    ...
    {RVM_CODE_POP_STACK_INT64, "pop_stack_int64", OPCODE_OPERAND_TYPE_2BYTE_As, -1, "int64 assign to local-variable", ""},
    ...
    {RVM_CODE_PUSH_STACK_INT64, "push_stack_int64", OPCODE_OPERAND_TYPE_2BYTE_As, 1, "push local-variable's int64 to stack", ""},
    ...
    {RVM_CODE_POP_FIELD_INT64, "pop_field_int64", OPCODE_OPERAND_TYPE_2BYTE_As, -1, "", "[int64,object]->[]"},
    ...
    {RVM_CODE_PUSH_FIELD_INT64, "push_field_int64", OPCODE_OPERAND_TYPE_2BYTE_As, 1, "", "[object]->[int64]"},
    ...
    {RVM_CODE_RELATIONAL_EQ_INT64, "eq_int64", OPCODE_OPERAND_TYPE_0BYTE, -1, "", ""},
    ...
    {RVM_CODE_RELATIONAL_NE_INT64, "ne_int64", OPCODE_OPERAND_TYPE_0BYTE, -1, "", ""},
    ...
    {RVM_CODE_RELATIONAL_GT_INT64, "gt_int64", OPCODE_OPERAND_TYPE_0BYTE, -1, "", ""},
    ...
    {RVM_CODE_RELATIONAL_GE_INT64, "ge_int64", OPCODE_OPERAND_TYPE_0BYTE, -1, "", ""},
    ...
    {RVM_CODE_RELATIONAL_LT_INT64, "lt_int64", OPCODE_OPERAND_TYPE_0BYTE, -1, "", ""},
    ...
    {RVM_CODE_RELATIONAL_LE_INT64, "le_int64", OPCODE_OPERAND_TYPE_0BYTE, -1, "", ""},
    ...
    {RVM_CODE_NEW_ARRAY_INT64, "new_array_int64", OPCODE_OPERAND_TYPE_1BYTE_A, 1, "", ""},
    ...
    {RVM_CODE_NEW_ARRAY_LITERAL_INT64, "new_array_literal_int64", OPCODE_OPERAND_TYPE_2BYTE_As, 1, "", ""},
    ...
    {RVM_CODE_INT64_2_STRING, "int64_2_string", OPCODE_OPERAND_TYPE_0BYTE, 0, "convert int64 to string", "[int]->[string]"},
